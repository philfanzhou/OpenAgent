...
| [session-architecture/](./session-architecture/README.md) | 会话架构重构系列（2026-09 审查驱动的 PR 拆分与说明报告） | 进行中 |
...
| [session-architecture/PR2-bwrap-args-single-source.md](./session-architecture/PR2-bwrap-args-single-source.md) | PR-2：Bubblewrap 沙箱安全加固参数单一事实源重构（动机/方案/等价性证明/回滚） | 已实施 |
