...
| PR | 报告 | 状态 |
|----|------|------|
| PR-1 | [PR1-unify-conversation-id-parsing.md](./PR1-unify-conversation-id-parsing.md) | 已完成 |
...
| PR-6 | [PR6-split-platform-chat-history.md](./PR6-split-platform-chat-history.md) | 已完成 |
