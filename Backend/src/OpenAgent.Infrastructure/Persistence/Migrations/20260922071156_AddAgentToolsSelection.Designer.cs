...
namespace OpenAgent.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260922071156_AddAgentToolsSelection")]
    partial class AddAgentToolsSelection
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenAgent.Infrastructure.Entities.FileShareLinkEntity", b =>
                {
                    b.Property<string>("ShareIdHash")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.HasKey("ShareIdHash");

                    b.HasIndex("FileId");

                    b.HasIndex("TenantId", "OwnerUserId", "CreatedAt");

                    b.ToTable("file_share_links", "openagent");
                });
            ...
            modelBuilder.Entity("OpenAgent.Infrastructure.Entities.LlmInteractionEntity", b =>
                {
                    ...
                    b.HasIndex("TenantId", "ConversationId", "StartedAt");

                    b.ToTable("llm_interaction_logs", "openagent");
                });
            ...
            modelBuilder.Entity("OpenAgent.Infrastructure.Entities.ThirdPartyApiKeyEntity", b =>
                {
                    ...
                    b.ToTable("third_party_api_keys", "openagent");
