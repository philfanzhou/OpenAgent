...
| 文档 | 决策 | 状态 |
|------|------|------|
| [0001-Logging-Framework-Serilog-Loki.md](./0001-Logging-Framework-Serilog-Loki.md) | 应用日志 Serilog + Loki + Grafana | 已决策 |
| [0002-Logging-Label-Design.md](./0002-Logging-Label-Design.md) | 日志 Label 命名与多实例扩展 | 待实施 |
